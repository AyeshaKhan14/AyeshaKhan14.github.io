...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 px-4 text-black font-bold fixed nav bg-orange-600 to-orange-700'>
      <div>
        <h1 className='text-5xl shadow-lg shadow-black font-style: italic ml-2'>
          <a
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='nav-links px-4 cursor-pointer capitalize font-bold text-xl text-black-500 hover:scale-105 hover:text-black duration-200 link-underline'>
          <a
            href={`https://drive.google.com/file/d/10FXUSWo7wEQ95gwPOqYgmQCXQ-Vlah3z/view?usp=sharing`}
            download={true}
            target='_blank'
            rel='noreferrer'
          >
