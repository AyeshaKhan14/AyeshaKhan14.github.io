...
const Home = () => (
  <div name='home' className='h-screen  w-full bg-stone-900 home'>
    <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center max-h-full px-4 md:flex-row'>
      <div className='small-screen hidden mt-8'>
        <img
          src={ayesha}
          alt='profile'
          className='border-orange-600 w-72  rounded-full'
        />
      </div>
      <div className='flex flex-col justify-center h-auto mt-36'>
        <div className=''>
          <h2 className='text-4xl sm:text-7xl font-bold text-white'>
            Hello, I'm <span className='text-orange-600'>Ayesha Khan</span>
          </h2>
          {/* typed-react */}
          ...
          <p className='font-medium	text-2xl text-gray-400 py-4 max-w-md'>
            I love to build websites using the latest front-end technologies and
            full fledged APIs.
          </p>
          ...
          <a
            ...
            rel='noreferrer'
          >
            <div className='group text-white w-fit px-6 py-3 my-2 flex items-center gap-2 rounded-md bg-gradient-to-b from-orange-600 to-orange-700 cursor-pointer'>
              {" "}
              <span className='font-medium text-xl'>Resume</span>{" "}
